...
/**
 * Servlet implementation class AddCustomerUIServlet
 */
...
public class AddCustomerUIServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("preference", utils.Globals.preferences);
		request.setAttribute("type", utils.Globals.types);
